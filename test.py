...
if __name__ == '__main__':
    ...
    sub = '/home/a6027/HSRNet/RSTPReid/1'
    parser.add_argument("--config_file", default=f'{sub}/configs.yaml')
    parser.add_argument("--use_occlusion", default=False, action='store_true', help='whether to use occlusion dataset')
    ...
    args = config_args
    args.training = False
    logger = setup_logger('HSRNet', save_dir=args.output_dir, if_train=args.training)
    logger.info(args)
    device = "cuda"
    args.output_dir = sub
