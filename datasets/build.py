...
def collate(batch):
    ...
    for k, v in dict_batch.items():
        if isinstance(v[0], int):
            ...
            # Handle string data (like img_path)
...
def build_dataloader(args, tranforms=None):
    ...
    dataset = __factory[args.dataset_name](root=args.root_dir, use_occlusion=args.use_occlusion if hasattr(args, 'use_occlusion') else False)
